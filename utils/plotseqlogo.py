###########################################################################################################################################################################################################
### Code from  https://github.com/c/concise (c) 2016, Žiga Avsec, Gagneur lab #############################################################################################################################
### adapted by Mahsa Ghanbari, Ohler lab in 2020 ##########################################################################################################################################################
### and modified by Frederick Korbel, Ohler lab in 2022 ###################################################################################################################################################
###########################################################################################################################################################################################################
...
#define the vocabularies for sequence logo generation
DNA = ["A", "C", "G", "T"]
RNA = ["A", "C", "G", "U"]
